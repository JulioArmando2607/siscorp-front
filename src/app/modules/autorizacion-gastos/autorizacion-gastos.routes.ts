...
import { AnalizarAutorizacionGastoComponent } from './analizar-autorizacion-gasto/analizar-autorizacion-gasto.component';
...
export default [
    ...
    {
        path: 'analizar-autorizacion-gasto/:id/:ag',
        component: AnalizarAutorizacionGastoComponent,
    },
